...
import io.restassured.filter.cookie.CookieFilter;
	...
	public class OlDateChange extends signin {

		public  Response olDateChange(ExtentTest test,int row,String payload,String baseuri,CookieFilter filter) throws Exception
		  {
		String method= new Exception() .getStackTrace()[0].getMethodName();	
				...
				Response res=given().filter(filter).
						     ...
						     header("X-USER-DETAILS", XUSEDETAILS).
				...
				//LNNumber = newData.get("loanNumber");
