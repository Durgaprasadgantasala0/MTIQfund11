...
public class Auth extends signin{
	public Response auth(ExtentTest test,int row,String payload,String baseuri,CookieFilter filter) throws Exception
	  {
